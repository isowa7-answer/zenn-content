...
もう一つ、正直な理由も書いておきたい。CSSアニメーションやWebGLでキャラを本格的に「動かす」のは、自分には難しいと感じていた。難しいだけならまだいいのだが、そもそも**どんなキーワードで参考事例を探せばいいのかも分からなかった**。「なめらかにキャラを歩かせる実装」を検索する語彙を、自分は持っていなかったのだ。だから止め絵の差し替えは、後ろ向きに言えば「自分にできる範囲に落とした」道でもある。ただ、やってみて分かったのは、これは負けの代替ではなかったということだ。「引き算」と言うと格好いいが、より本当のところは**自分が歩ける道を選んだ**——そして歩けた道の先に、なめらかなアニメより「いる」感があった。できる範囲が、たまたま正解に繋がっていた。
...
なぜ覗きが一番効くのか、あとから腑に落ちた理由がある。「いる」の正体は、**ずっと見守られていること**ではなく、**壁の陰から時々こちらを覗いて「あ、見てくれてるんだな」と感じる瞬間**のほうにあったのだ。もし常時こちらをじっと見ているキャラだったら、それは「いる」ではなく「こわい」になる。監視されている感じが出てしまう。`peek` が刺さったのは、15秒に一度、他のポーズの合間にふっと覗いて、また座る——その**間欠的な視線**が、監視ではなく「気にかけてくれている」に見えたからだった。これは設計する前に狙って作ったものではなく、巡回を淡々と回していたら結果的にそうなった。だが振り返ると、`peek` を巡回に混ぜたこと・常時表示にしなかったことが、「いる」と「こわい」を分ける分岐点だったと思う。
...
でも、JS側でこれらの `blinking` / `sleeping` クラスを付けている箇所はない。`clearMascotClasses()` が「消す対象」として名前を知っているだけで、誰も付けない。だから現状、瞬きも睡眠もジャンプも伸びも、画面では起きない。「止まっていても動いて見えるように瞬かせたい」「かまわないと眠らせたい」という当初の願いの、書きかけのまま残った化石だ。

強調しておきたいのは、これは技術的に**できなかった**のではなく、目的に届いていたから**止めた**ということ。呼吸・小揺れ・跳ねの三つと止め絵の差し替えで「一番簡単に"いる"を出す」には十分で、これ以上配線する必要がなかった。化石が残っているのは、設計ミスというより、作りながら設計が育った跡だと思っている。消さずに残してあるのは、いつか気が向いたら繋ぐかもしれないから、くらいの理由でしかない。
